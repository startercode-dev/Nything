...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"utils/helper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.formData = exports.eventRoute = exports.apiConnect = void 0;
...
var eventRoute = function eventRoute(selector, action, fn, condition) {
  //Checks if selector exist and creates route from event trigger to function execution
  var exist = (0, _jquery.default)(selector).length > 0;
  var conditionValidation = condition !== undefined ? condition : true;

  if (exist && conditionValidation) {
    (0, _jquery.default)(selector).on(action, function (e) {
      e.preventDefault();
      return fn(e);
    });
  }
...
var apiConnect = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(method, url, data, alertMessage, redirect) {
    var res;
  ...
  return function apiConnect(_x, _x2, _x3, _x4, _x5) {
...
var formData = function formData(target) {
...
},{"jquery":"../../node_modules/jquery/dist/jquery.js","axios":"../../node_modules/axios/index.js"}],"utils/eventActions.js":[function(require,module,exports) {
"use strict";
...
var Action = /*#__PURE__*/function () {
  ...
  _createClass(Action, [{
    ...
    value: function login(e) {
      (0, _helper.apiConnect)('POST', '/api/v1/users/login', (0, _helper.formData)(e.target), 'Logged in successfully!', '/');
    }
  }, {
    key: "logout",
    value: function logout() {
      (0, _helper.apiConnect)('GET', '/api/v1/users/logout', {}, undefined, '/');
    }
  }, {
    key: "signup",
    value: function signup(e) {
      (0, _helper.apiConnect)('POST', '/api/v1/users/signup', (0, _helper.formData)(e.target), 'Signup successful', '/');
    }
  }, {
    key: "popularPost",
    value: function popularPost(e) {
      //Clicking on popular post in home page
      var cTarget = (0, _jquery.default)(e.currentTarget);
      var id = cTarget[0].dataset.id;
      location.href = "/post/".concat(id);
    }
  }, {
    key: "myPostItems",
    value: function myPostItems(e) {
      //Clicking on one of my post
      var target = (0, _jquery.default)(e.target);
      var postId = (0, _jquery.default)(e.currentTarget)[0].dataset.id;
      if (target.hasClass('my-posts-title')) return location.assign("/post/".concat(postId));

      if (target.hasClass('my-post-icons--delete')) {
        return (0, _helper.apiConnect)('DELETE', "/api/v1/posts/".concat(postId), {}, 'Post deleted successfully!', 'reload');
      }

      if (target.hasClass('my-post-icons--edit')) return location.assign("/post/update/".concat(postId));
    }
  }, {
    key: "newComment",
    value: function newComment(e) {
      var postId = window.location.pathname.split('/')[2];
      (0, _helper.apiConnect)('POST', "/api/v1/posts/".concat(postId, "/comments"), (0, _helper.formData)(e.target), 'You have successfully commented on this post', 'reload');
    }
  }, {
    key: "changePassword",
    value: function changePassword(e) {
      (0, _helper.apiConnect)('PATCH', '/api/v1/users/updatePassword', (0, _helper.formData)(e.target), 'You have successfully updated your password', '/');
    }
  }, {
    key: "accountSettings",
    value: function accountSettings(e) {
      (0, _helper.apiConnect)('PATCH', '/api/v1/users/updateMe', (0, _helper.formData)(e.target), 'You have successfully updated your settings', '/');
    }
  }, {
    key: "forgotPassword",
    value: function forgotPassword(e) {
      (0, _helper.apiConnect)('POST', '/api/v1/users/forgotPassword', (0, _helper.formData)(e.target), 'A reset link was successfully sent to your email', '/');
    }
  }, {
    key: "resetPassword",
    value: function resetPassword(e) {
      var token = window.location.pathname.split('/')[2];
      (0, _helper.apiConnect)('PATCH', "/api/v1/users/resetPassword/".concat(token), (0, _helper.formData)(e.target), 'You have successfuly reset your password', '/');
    }
  }, {
    key: "createPost",
    value: function createPost(e) {
      (0, _helper.apiConnect)('POST', '/api/v1/posts', (0, _helper.formData)(e.target), 'Thank you for making a post!', '/');
    }
  }, {
    key: "updatePost",
    value: function updatePost() {
      var postId = window.location.pathname.split('/')[3];
      (0, _helper.apiConnect)('PATCH', "/api/v1/posts/".concat(postId), (0, _helper.formData)(e.target), 'Post has been successfully updated', '/');
    }
  }]);
...
},{"jquery":"../../node_modules/jquery/dist/jquery.js","./helper.js":"utils/helper.js"}],"utils/populate.js":[function(require,module,exports) {
"use strict";
...
var Populate = /*#__PURE__*/function () {
  ...
  _createClass(Populate, [{
    key: "updatePost",
    value: function () {
      var _updatePost = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var postId, _yield$apiConnect, post, forum, title, paragraph;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return (0, _helper.apiConnect)('GET', "/api/v1/posts/".concat(postId), {}, undefined, undefined);

              case 3:
                _yield$apiConnect = _context.sent;
                post = _yield$apiConnect.post;
                forum = post.forum, title = post.title, paragraph = post.paragraph;
                (0, _jquery.default)('#forumsSelect').val(forum._id);
                (0, _jquery.default)('.title-input').val(title);
                (0, _jquery.default)('#paragraph').val(paragraph);
    ...
    key: "forumSelect",
    value: function () {
      var _forumSelect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var forumData;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return (0, _helper.apiConnect)('GET', '/api/v1/forums?sort=forum', {}, undefined, undefined);

              case 2:
                forumData = _context2.sent;
                (0, _jquery.default)(forumData.data).each(function (i, r) {
                  (0, _jquery.default)('#forumsSelect').append("<option value=\"".concat(r._id, "\">").concat(r.forum, "</option>"));
                });
      ...
      function forumSelect() {
        return _forumSelect.apply(this, arguments);
      }
...
},{"jquery":"../../node_modules/jquery/dist/jquery.js","./helper.js":"utils/helper.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _eventActions = _interopRequireDefault(require("./utils/eventActions.js"));

var _populate = _interopRequireDefault(require("./utils/populate.js"));
...
(0, _jquery.default)(document).ready( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          //EVENT ROUTES
          (0, _helper.eventRoute)('.login-form', 'submit', _eventActions.default.login);
          (0, _helper.eventRoute)('.nav-logout', 'click', _eventActions.default.logout);
          (0, _helper.eventRoute)('.signup-form', 'submit', _eventActions.default.signup);
          (0, _helper.eventRoute)('.popular-post-box', 'click', _eventActions.default.popularPost);
          (0, _helper.eventRoute)('.my-posts-item', 'click', _eventActions.default.myPostItems);
          (0, _helper.eventRoute)('.comment-form', 'submit', _eventActions.default.newComment);
          (0, _helper.eventRoute)('.form--passwordChange', 'submit', _eventActions.default.changePassword);
          (0, _helper.eventRoute)('.form--account-settings', 'submit', _eventActions.default.accountSettings);
          (0, _helper.eventRoute)('.form--forgotPassword', 'submit', _eventActions.default.forgotPassword);
          (0, _helper.eventRoute)('.form--resetPassword', 'submit', _eventActions.default.resetPassword);
          (0, _helper.eventRoute)('.section-createPost', 'submit', _eventActions.default.createPost, window.location.pathname.startsWith('/post/create'));
          (0, _helper.eventRoute)('.section-createPost', 'submit', _eventActions.default.updatePost, window.location.pathname.startsWith('/post/update')); //POPULATES

          if (window.location.pathname.startsWith('/post/update')) {
            _populate.default.updatePost();
          }

          if ((0, _jquery.default)('#forumsSelect').length > 0) {
            _populate.default.forumSelect();
          }
